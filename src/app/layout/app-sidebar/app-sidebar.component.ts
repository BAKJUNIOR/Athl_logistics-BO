...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    },
    {
      ...
      subItems: [
        { name: "Éléments de formulaire", path: "/form-elements", pro: false }
      ],
    },
    {
      name: "Tableaux",
      ...
      subItems: [
        { name: "Tableaux simples", path: "/basic-tables", pro: false },
      ],
    },
    {
      name: "Pages",
  ...
  othersItems: NavItem[] = [
    {
      ...
      name: "Graphiques",
      subItems: [
        { name: "Graphique en ligne", path: "/line-chart", pro: false },
        { name: "Graphique en barres", path: "/bar-chart", pro: false },
      ],
    },
    {
